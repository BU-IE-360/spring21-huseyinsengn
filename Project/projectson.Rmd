...
```{r}
data_path= 'C:/Users/admin/Documents/GitHub/spring21-huseyinsengn/files/Project/Project/ProjectRawData (2).csv'
...
```{r}
day_type <- read_excel("daytype.xlsx",range="C1:C372",col_names=FALSE)
...
IslakMendil<-daily_data[product_content_id==4066298]
head(IslakMendil)
...
```
```{r pressure, echo=FALSE}
projectdata <- read.csv("ProjectRawData (2).csv")
